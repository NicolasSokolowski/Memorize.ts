  ...
  return (
    ...
    >
      <div className="flip-card-front">
        <div className="mx-4 mb-6 flex size-full flex-col rounded-lg bg-tertiary shadow-lg">
        ...
        <div className="flip-card-back">
          ...
          >
            <div className="flip-card-back-face">
              <div className="mx-4 mb-6 flex size-full flex-col justify-start rounded-lg bg-tertiary shadow-lg">
                <h3 className="m-4 text-center font-patua text-2xl text-textPrimary">
            ...
            <div className="flip-card-back-of-back">
              <div className="mx-4 mb-6 flex size-full flex-col rounded-lg bg-tertiary font-patua text-textPrimary shadow-lg">
